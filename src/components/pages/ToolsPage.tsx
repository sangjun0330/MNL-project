      ...
      <Link href="/tools/nurse-calculators" className="block">
        <Card className="p-6 transition hover:translate-y-[-1px] hover:border-[color:var(--rnest-accent-border)]">
          <div className="flex items-start justify-between gap-3">
            ...
            <span className="rnest-chip-accent shrink-0 whitespace-nowrap px-3 py-1 text-[11px]">{t("LOCAL")}</span>
          </div>
        </Card>
      </Link>
      ...
      <Link href="/tools/med-safety" className="block">
        <Card className="p-6 transition hover:translate-y-[-1px] hover:border-[color:var(--rnest-accent-border)]">
          <div className="flex items-start justify-between gap-3">
            ...
            <span className="rnest-chip-accent shrink-0 whitespace-nowrap px-3 py-1 text-[11px]">{billingLoading ? t("AI") : `${t("남은")} ${medSafetyRemaining}${t("회")}`}</span>
          </div>
        </Card>
      </Link>
    </div>
