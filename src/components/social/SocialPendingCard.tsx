  ...
  return (
    <div className="space-y-2">
            ...
            {incoming.map((c) => (
              <div key={c.id} className="flex items-center gap-3 px-4 py-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[12px] text-ios-muted">연결 요청을 보냈어요</p>
                </div>
                <div className="flex shrink-0 gap-2">
                  ...
                  <button
                    ...
                    className="rounded-full bg-ios-bg px-3.5 py-1.5 text-[12.5px] font-semibold text-ios-muted transition active:opacity-60 disabled:opacity-40"
                  >
                    거절
                  </button>
                </div>
      ...
      {sent.length > 0 && (
        <div className="rounded-apple border border-ios-sep bg-white shadow-apple">
          <div className="px-4 pt-3 pb-1">
            <span className="text-[12px] font-semibold text-ios-muted">보낸 요청</span>
          </div>
          <div className="divide-y divide-ios-sep">
            {sent.map((c) => (
              <div key={c.id} className="flex items-center gap-3 px-4 py-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[13.5px] font-semibold text-ios-text truncate">
                    {c.nickname || "익명"}
                    <span className="ml-2 text-[11px] font-normal text-ios-muted">수락 대기 중</span>
                  </p>
                </div>
                <button
                  type="button"
                  ...
                  className="rounded-full bg-ios-bg px-3.5 py-1.5 text-[12.5px] font-semibold text-red-500 transition active:opacity-60 disabled:opacity-40"
                >
                  취소
                </button>
              </div>
