...
export const SEARCH_CREDIT_META_MAP: Record<SearchCreditType, SearchCreditMeta> = {
  ...
  premium: {
    ...
    title: "프리미엄 검색",
    shortTitle: "프리미엄",
    description: "웹 검색 포함 — 복잡한 임상 판단을 뒷받침하는 고급 검색",
    purchaseHint: "웹 검색으로 최신 자료까지 참고 · 복합 약물 상호작용·희귀 케이스 등 깊은 해석이 필요할 때 추천",
    model: "gpt-5.4",
  },
};
...
const CHECKOUT_PRODUCT_MAP: Record<CheckoutProductId, CheckoutProductDefinition> = {
  ...
  premium10: {
    ...
    kind: "credit_pack",
    title: "프리미엄 검색 10회",
    description: "웹 검색 포함 — 복잡한 임상 판단을 뒷받침하는 고급 검색 10회",
    priceKrw: 1500,
  ...
  premium30: {
    ...
    kind: "credit_pack",
    title: "프리미엄 검색 30회",
    description: "웹 검색 포함 — 복잡한 임상 판단을 뒷받침하는 고급 검색 30회",
    priceKrw: 3900,
