...
const PLAN_MAP: Record<PlanTier, PlanDefinition> = {
  ...
  plus: {
    tier: "plus",
    title: "Plus",
    description: "회복 플래너 화면과 기본 검색을 함께 쓰는 플랜입니다. 기본 검색 20회와 프리미엄 검색 3회가 포함됩니다.",
    priceKrw: 9900,
    periodDays: DEFAULT_PERIOD_DAYS,
  ...
  pro: {
    tier: "pro",
    title: "Pro",
    description: "기본 검색과 프리미엄 검색을 폭넓게 쓰는 플랜입니다. 기본 검색 50회와 프리미엄 검색 30회가 포함됩니다.",
    priceKrw: 14900,
    periodDays: DEFAULT_PERIOD_DAYS,
