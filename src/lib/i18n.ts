...
const EN_EXTRA: Record<string, string> = {
  ...
  "계산기 검색...": "Search calculators...",
  "모든 도구": "All Tools",
  "투약·주입": "Medication / Infusion",
  "환자 평가": "Patient Assessment",
  "임상 계산": "Clinical Calculations",
  "AI 도구": "AI Tools",
  "NEW": "NEW",
  "펌프 변환": "Pump Conversion",
  "처방 용량 → mL/hr 변환": "Convert ordered dose to mL/hr",
  "IVPB 속도": "IVPB Rate",
  "간헐적 정맥주입 속도 계산": "Calculate intermittent IV rate",
  "드립 환산": "Drip Conversion",
  "mL/hr ↔ gtt/min 환산": "mL/hr ↔ gtt/min conversion",
  "희석 농도": "Dilution / Concentration",
  "희석 후 농도 계산": "Calculate post-dilution concentration",
  "역산 검산": "Dose Verify",
  "현재 펌프 설정 역산 검증": "Reverse-check current pump setting",
  "소아 용량 계산": "Pediatric Dose",
  "체중 기반 mg/kg 소아 용량 산출": "Weight-based mg/kg pediatric dosing",
  "GCS 의식 평가": "GCS Assessment",
  "Glasgow Coma Scale 점수 산출": "Glasgow Coma Scale scoring",
  "BMI 계산": "BMI Calculator",
  "체질량지수 및 아시아 기준 분류": "BMI with Asian cutoffs",
  "BSA 체표면적": "BSA Calculator",
  "항암·소아 투약 기준 체표면적": "Body surface area for chemo/peds dosing",
  "CrCl 신기능": "CrCl Calculator",
  "Cockcroft-Gault 크레아티닌 청소율": "Cockcroft-Gault creatinine clearance",
  "수액 밸런스 (I/O)": "Fluid Balance (I/O)",
  "섭취량/배출량 합산 및 수분 균형": "Intake/output totals and net balance",
  "단위 변환기": "Unit Converter",
  "체온·체중·길이·질량·용량 단위 변환": "Temp, weight, length, mass, volume conversions",
  "체온·체중·질량·용량 변환": "Temperature, weight, mass, and volume conversions",
  "최근 검색 기록": "Recent Searches",
  "AI 검색 히스토리 확인": "View AI search history",
  "검색 결과가 없습니다.": "No matching tools found.",
  // Tools: GCS page
  "의식 수준을 빠르게 평가합니다.": "Quickly assess consciousness level.",
  "Glasgow Coma Scale 점수 계산": "Glasgow Coma Scale score",
  "GCS 총점": "Total GCS score",
  "눈 반응 (E)": "Eye Response (E)",
  "언어 반응 (V)": "Verbal Response (V)",
  "운동 반응 (M)": "Motor Response (M)",
  "반응 없음": "None",
  "통증에 개안": "To pain",
  "음성에 개안": "To voice",
  "자발적 개안": "Spontaneous",
  "이해 불가 소리": "Incomprehensible",
  "부적절한 단어": "Inappropriate",
  "혼돈 대화": "Confused",
  "지남력 보존": "Oriented",
  "신전": "Extension",
  "비정상 굴곡": "Abnormal flexion",
  "도피 반응": "Withdrawal",
  "통증 국재화": "Localizes pain",
  "지시 따름": "Obeys commands",
  "경도": "Mild",
  "중등도": "Moderate",
  "중증": "Severe",
  "결과": "Result",
  ...
  "체중 (kg)": "Weight (kg)",
  "신장 (cm)": "Height (cm)",
  "아시아 기준": "Asian cutoffs",
  "WHO 기준": "WHO cutoffs",
  "체질량지수 (아시아 기준 포함)": "Body mass index (with Asian cutoffs)",
  "저체중": "Underweight",
  "정상": "Normal",
  "과체중": "Overweight",
  "비만": "Obese",
  "비만 2단계": "Obese II",
  "비만 3단계": "Obese III",
  "체질량지수를 계산합니다.": "Calculate body mass index.",
  // Tools: BSA page
  "체표면적을 계산합니다.": "Calculate body surface area.",
  "DuBois / Mosteller 공식": "DuBois / Mosteller formulas",
  "체표면적": "Body surface area",
  "DuBois 공식": "DuBois formula",
  "Mosteller 공식": "Mosteller formula",
  // Tools: CrCl page
  "크레아티닌 청소율을 계산합니다.": "Calculate creatinine clearance.",
  "나이": "Age",
  "나이 (세)": "Age (years)",
  "Cockcroft-Gault 청소율 계산": "Cockcroft-Gault creatinine clearance",
  "혈청 크레아티닌 (mg/dL)": "Serum Creatinine (mg/dL)",
  "성별": "Sex",
  "남성": "Male",
  "여성": "Female",
  "신기능 정상": "Normal",
  "경도 저하": "Mild decrease",
  "중등도 저하": "Moderate decrease",
  "중증 저하": "Severe decrease",
  "신부전": "Kidney failure",
  // Tools: Unit converter
  "의료 현장 단위를 즉시 변환합니다.": "Instantly convert clinical units.",
  "온도": "Temperature",
  "체중": "Weight",
  "길이": "Length",
  "질량": "Mass",
  ...
  "변환 후": "To",
  // Tools: Fluid balance
  "수분 균형을 계산합니다.": "Calculate fluid balance.",
  "수액 밸런스": "Fluid balance",
  "섭취/배출 I/O 계산": "Intake/output balance calculation",
  "섭취량": "Intake",
  "섭취 (Intake)": "Intake",
  "배출량": "Output",
  "배출 (Output)": "Output",
  "불감손실 (mL)": "Insensible Loss (mL)",
  "불감 손실 (mL)": "Insensible loss (mL)",
  "일반 성인 기준 약 500~800 mL/일": "Typical adult estimate: about 500-800 mL/day",
  "항목 추가": "Add entry",
  "항목을 추가하세요": "Add an entry to begin",
  "항목 선택": "Select item",
  "총 섭취": "Total intake",
  "총 배출": "Total output",
  "순 밸런스": "Net balance",
  ...
  "소아 체중 기반 용량을 계산합니다.": "Calculate weight-based pediatric dose.",
  "체중 기반 mg/kg 용량 산출": "Weight-based mg/kg dose calculation",
  "용량 (mg/kg)": "Dose (mg/kg)",
  "선택: 최대 용량 상한": "Optional: maximum dose caps",
  "1회 최대 (mg)": "Max per dose (mg)",
  "일일 최대 (mg)": "Max per day (mg)",
  "미입력 시 상한 없음": "No cap if left blank",
  "체중당 용량": "Dose per kg",
  "용량 단위": "Dose unit",
  "투여 횟수 (회/일)": "Frequency (times/day)",
  "최대 1회 용량": "Max single dose",
  "최대 일일 용량": "Max daily dose",
  "1회 용량": "Single dose",
  "일일 총 용량": "Total daily dose",
  "상한 적용": "Cap applied",
  "일일 용량": "Daily dose",
  "상한 적용됨": "Cap applied",
  "안전 참고": "Safety Note",
  // Tools: nurse calculators / med-safety (existing)
  ...
  "계정에 저장된 완료 검색 결과를 정리하고 있습니다.":
    "Organizing completed results saved to your account.",
  "최근 기록 조회에 실패했습니다.": "Failed to load recent history.",
  "저장된 기록이 없습니다": "No saved history yet",
  ...
  "결과 복사": "Copy result",
  "가이드 복사": "Copy guide",
  "화면에 보이는 구조대로 복사됩니다.": "Copies in the same structure shown on screen.",
  "현재 화면 카드 순서대로 복사됩니다.": "Copies in the same order as the visible result cards.",
  "결과를 형식에 맞게 복사했습니다.": "Copied in a clean formatted layout.",
  "클립보드를 사용할 수 없습니다.": "Clipboard is not available.",
  "복사에 실패했습니다.": "Failed to copy.",
  "정리된 복사본": "Formatted copy",
  "최근 저장": "Recent saved",
  "마지막 저장": "Last saved",
  ...
  "선택한 검색 결과가 여기 표시됩니다.": "The selected search result appears here.",
  "추가 참고": "Additional context",
  "추천 이름": "Suggested names",
  "재검색 안내": "Retry guidance",
