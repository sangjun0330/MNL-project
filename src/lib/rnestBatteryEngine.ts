...
export type RNestDailyDiagnostics = {
  // normalized
  stress_n: number;
  activity_n: number;
  mood_bad_n: number;
...
export type RNestDailyResult = {
  nextState: RNestHiddenState;
  diagnostics: RNestDailyDiagnostics;
};
...
function resolveSleepTiming(timing: RNestDailyInputs["sleepTiming"], shift: Shift) {
...
export function defaultRNestState(): RNestHiddenState {
